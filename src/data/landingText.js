...
export const LANDING_FEATURES = [
  {
    title: 'WEFLOW CARE PLAN',
    desc: '제작부터 운영 · 광고 · 관리까지 한 번에 해결합니다.',
    icon: '🔗',
  },
  {
    title: '빠른 제작 진행',
    desc: '랜딩페이지 3~4일, 홈페이지 약 1주일.\n빠르게 제작하고 빠르게 운영을 시작합니다.',
    icon: '🚀',
  },
  {
    title: '합리적인 비용',
    desc: '불필요한 비용 없이 필요한 기능만 구성하여\n가성비 + 실속 + 퀄리티를 함께 제공합니다.',
    icon: '💰',
  },
  {
    title: '24시간 상담 가능',
    desc: '정해진 시간만 기다리지 마세요.\n문의가 생길 때 언제든 빠른 상담 및 피드백 가능합니다.',
    icon: '📞',
  },
  {
    title: '제작 후 운영 관리',
    desc: '홈페이지 만들고 끝이 아닙니다.\n검색 등록, 수정, 유지보수, 운영 관리까지 함께합니다.',
    icon: '🛠️',
  },
  {
    title: '광고 연동 지원',
    desc: '홈페이지 + 랜딩페이지 + 광고를 한 번에 연결해 문의가 들어오는 구조를 만듭니다.\n인스타 · 스레드 · 블로그 · 카카오톡 · 당근 플레이스 등.',
    icon: '📢',
  },
];
